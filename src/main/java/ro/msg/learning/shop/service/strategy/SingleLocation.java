...
//
//    stockDTOS = stockRepository.findStockLocationsForOneProduct(productId, quantity).stream().map(p ->
//      new StockMapper(locationRepository, productRepository).convertToDto(p)
